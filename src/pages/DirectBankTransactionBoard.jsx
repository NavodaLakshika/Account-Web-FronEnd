                    ...
                    <div className="bg-white p-4 border border-slate-200 rounded-[3px] space-y-4">
                        <div className="grid grid-cols-12 gap-x-6 gap-y-3.5">
                            ...
                            <div className="col-span-4">
                                ...
                                <div className="relative">
                                    <input type="text" value={formData.relevantDate} className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] pr-10 text-gray-700 truncate" name="relevantDate" onChange={(e) => setFormData(prev => ({ ...prev, relevantDate: e.target.value }))} />
