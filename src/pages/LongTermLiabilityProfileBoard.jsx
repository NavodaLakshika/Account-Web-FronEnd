...
const LongTermLiabilityProfileBoard = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            <TransactionFormWrapper boardName="LongTermLiabilityProfileBoard" icon={null}
                        ...
                        <div className="grid grid-cols-12 gap-x-6 gap-y-3.5">
                            ...
                            <div className="col-span-4">
                                ...
                                <div className="relative">
                                    <input type="text" value={formData.OrgDate} className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] pr-10 text-gray-700 " name="OrgDate" onChange={(e) => setFormData(prev => ({ ...prev, OrgDate: e.target.value }))} />
