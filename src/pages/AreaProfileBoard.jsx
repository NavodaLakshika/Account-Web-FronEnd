                        ...
                        <div className="grid grid-cols-12 gap-x-6 gap-y-3.5">
                            <div className="col-span-12">
                                ...
                                <div className="relative">
                                    <input type="text" readOnly value={formData.Route_Name || formData.Route_Code} onClick={openRouteSearch} placeholder="Select route..." className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] pr-10 text-gray-700 cursor-pointer" />
                            ...
                            <div className="col-span-6">
                                ...
                                <div className="relative">
                                    <input type="text" readOnly value={formData.Code || ''} onClick={openAreaSearch} className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] pr-10 text-gray-700 font-mono cursor-pointer" />
                                    <button onClick={openAreaSearch} className="absolute right-1 top-1 bottom-1 w-8 flex items-center justify-center text-gray-500 hover:text-gray-800 bg-transparent border-none cursor-pointer"><Search size={16} /></button>
                                </div>
                            </div>
                            <div className="col-span-6">
