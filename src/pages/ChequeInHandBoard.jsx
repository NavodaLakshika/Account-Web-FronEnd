...
const ChequeInHandBoard = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            <TransactionFormWrapper subtitle="Cheque in Hand" icon={null}
                isOpen={isOpen}
                onClose={onClose}
                        ...
                        <div className="grid grid-cols-12 gap-x-6 gap-y-3.5">
                            <div className="col-span-8">
                                ...
                                <div className="relative">
                                    <input type="text" readOnly value={header.bankName ? `${header.bankCode} - ${header.bankName}` : ''} placeholder="Identify the bank for instrument custody..."
