                    ...
                    <div className="bg-white p-4 border border-slate-200 rounded-[3px]">
                        ...
                        <div className="grid grid-cols-12 gap-x-4 gap-y-3.5 items-end">
                            <div className="col-span-2">
                                ...
                                <div className="relative">
                                    <input type="text" value={entry.writeDate} className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] pr-10 text-gray-700 truncate" name="writeDate" onChange={(e) => setEntry(prev => ({ ...prev, writeDate: e.target.value }))} />
