...
import { Search, Calendar, CheckCircle, RotateCcw, Save } from 'lucide-react';
            ...
            <div className="space-y-4 overflow-y-auto no-scrollbar font-['Tahoma']">
                <div className="bg-white p-4 border border-gray-100 rounded-lg shadow-sm space-y-4">
                    <div className="grid grid-cols-12 gap-x-6 gap-y-3.5">
                        ...
                        <div className="col-span-4 flex items-center gap-2">
                            ...
                            <input type="text" name="costCenter" value={formData.costCenter} onChange={handleInput} className="flex-1 min-w-0 h-8 border border-gray-300 px-3 text-[12px] font-bold text-gray-700 bg-white rounded-[5px] outline-none focus:border-[#0285fd] shadow-sm" placeholder="Optional" />
                        </div>
                        ...
                        <div className="col-span-4 flex items-center gap-2">
                            ...
                            <input type="text" name="department" value={formData.department} onChange={handleInput} className="flex-1 min-w-0 h-8 border border-gray-300 rounded-[5px] px-3 text-[12px] outline-none bg-white text-gray-700 shadow-sm focus:border-[#0285fd]" placeholder="Optional" />
                        </div>
                ...
                <div className="border border-gray-100 rounded-lg bg-white shadow-sm flex flex-col min-h-[350px] overflow-hidden">
                    <div className="flex bg-slate-50/80 border-b border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-widest items-center">
                        ...
                        <div className="w-28 py-2.5 px-3 border-r border-gray-100 text-center">Payer</div>
                    ...
                    <div className="flex-1 bg-white overflow-y-auto max-h-[320px] divide-y divide-gray-50">
                        {funds.length === 0 ? (
                            ...
                            <div key={idx} onClick={() => toggleDocSelection(getDocNo(f))} className={`flex border-b border-gray-100 text-[11px] font-bold text-slate-700 hover:bg-blue-50/30 items-center transition-colors cursor-pointer ${selectedDocNos.has(getDocNo(f)) ? 'bg-blue-50/50' : ''}`}>
                                ...
                                <div className="flex-[1.5] py-2 px-4 border-r border-gray-100 text-blue-600 font-mono">{getDocNo(f)}</div>
                                ...
                                <div className="w-28 py-2 px-3 border-r border-gray-100 text-center">{f.name || f.payType || ''}</div>
