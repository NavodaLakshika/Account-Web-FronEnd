            ...
            <TransactionFormWrapper
                ...
                footer={
                    <div className="bg-[#fcfcfc] px-6 py-4 w-full flex justify-between items-center border-t border-gray-200 rounded-b-[10px] shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)]">
                        ...
                        <div className="flex gap-3">
                            <button onClick={() => handleSave(false)} className="px-6 py-2 border-2 border-[#0285fd] text-[#0285fd] bg-white hover:bg-blue-50 font-semibold rounded-[3px] shadow-sm text-[13px] transition-all flex items-center justify-center gap-2">
                                <Save size={14} /> SAVE DRAFT
                            </button>
                            <button onClick={() => handleSave(true)} className="px-6 py-2 bg-[#0285fd] hover:bg-[#0073ff] text-white font-semibold rounded-[3px] shadow-sm text-[13px] transition-all flex items-center justify-center gap-2">
                                <Check size={14} /> APPLY
                            </button>
                        </div>
                    </div>
