    ...
    const loadInitialData = async () => {
        try {
            ...
            const [lookupRes, docRes] = await Promise.all([
                mainCashService.getLookups(companyCode),
                mainCashService.generateDocNo(companyCode)
            ]);
                        ...
                        <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50 font-['Plus_Jakarta_Sans']">
                            ...
                            <div className="flex gap-4">
                                <input 
                                    ...
                                    autoFocus
                                />
                                <button onClick={() => setActiveModal(null)} className="w-8 h-8 flex items-center justify-center hover:bg-red-50 text-slate-400 hover:text-red-500 transition-colors rounded-full transition-all"><X size={24} /></button>
                            </div>
                        </div>
