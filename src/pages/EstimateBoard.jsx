...
const EstimateBoard = ({ isOpen, onClose }) => {
    ...
    const fetchInitialData = async (company) => {
        try {
            ...
            setNewDocNo(docData.docNo);

            const orderList = await quotationService.searchDocs(company).catch(() => []);
            setOrders(orderList || []);
        } catch (error) {
    ...
    return (
        <>
            ...
            <TransactionFormWrapper boardName="EstimateBoard" isOpen={isOpen} onClose={onClose}
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        {(lookups.terms || []).map((t, idx) => (
                                            <option key={idx} value={t.name || t.code || t.itemId || t.id || t}>
