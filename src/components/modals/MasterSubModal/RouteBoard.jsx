...
const RouteBoard = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            <SimpleModal isOpen={isOpen} onClose={onClose} title="Route Selection" maxWidth="max-w-[500px]" footer={footer}>
                ...
                <AdminConfigPanel entityType="ROUTE" entityCode={formData.Code} company={formData.Company} />
            </SimpleModal>
            ...
            <ConfirmModal
                ...
                title="Delete Route"
                message={`Are you sure you want to delete route ${formData.Route_Name || formData.Code}? This action cannot be undone.`}
                variant="danger"
                loading={loading}
