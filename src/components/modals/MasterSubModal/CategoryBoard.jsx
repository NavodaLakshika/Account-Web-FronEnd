        ...
        >
            <div className="space-y-4 min-h-[300px]">
                <div className="border-b border-gray-200 pb-2 mb-4">
                    <h2 className="text-sm font-bold text-gray-800">Enter New Category Details & Update</h2>
                </div>
                ...
                <div className="bg-gray-50 p-6 border border-gray-200 rounded-sm space-y-4">
                    ...
                    {/* Category ID / Name */}
                    <div className="flex items-center gap-3">
                        <label className="text-xs font-semibold text-gray-600 w-[120px] shrink-0">Category ID / Name</label>
                        <div className="flex flex-1 gap-2">
                            <input 
                                type="text" 
                                className="w-32 h-8 border border-gray-300 px-2 text-sm focus:border-blue-500 outline-none rounded-sm"
