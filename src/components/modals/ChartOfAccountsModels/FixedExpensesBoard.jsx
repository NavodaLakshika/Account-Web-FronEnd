                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    className="w-full h-8 border border-slate-200 px-3 text-[12px] font-bold outline-none shadow-sm focus:border-[#ff3b30] focus:ring-2 focus:ring-[#ff3b30]/20 bg-white rounded text-gray-700 cursor-pointer"
                                >
