...
const LogoutConfirmModal = ({ isOpen, onClose, onConfirm, loading = false }) => {
    ...
    return (
        <div className="fixed inset-0 z-[1200] flex items-center justify-center p-4 sm:p-6 font-['Plus_Jakarta_Sans'] pointer-events-auto">
            ...
            <div className="relative w-full max-w-[600px] bg-white rounded-[3px] shadow-[0_10px_40px_rgb(0,0,0,0.3)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
