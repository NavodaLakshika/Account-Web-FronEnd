...
const AboutUsModal = ({ isOpen, onClose }) => {
    return (
        <>
            ...
            <div
                className={`fixed top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-[1150px] h-[230px] bg-white/95 backdrop-blur-[40px] z-[1000] rounded-[2px] border border-gray-200 transition-all duration-1000 ease-[cubic-bezier(0.19,1,0.22,1)] ${isOpen ? 'translate-y-0 opacity-100 shadow-[0_40px_80px_rgba(0,0,0,0.1)]' : '-translate-y-[calc(100%+80px)] opacity-0 pointer-events-none'
                    }`}
