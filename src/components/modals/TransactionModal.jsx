    ...
    return (
        <>
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                ...
                {/* Modal Container */}
                <div className="relative w-full max-w-[350px] bg-white border border-gray-100 rounded-xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                    ...
                    <div className="bg-white px-6 py-4 flex items-center justify-between border-b border-gray-100 select-none relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[15px] font-[700] text-slate-900 uppercase tracking-[3px] font-mono truncate">Transaction Center</span>
                        </div>
                        <button 
                            onClick={onClose} 
                    ...
                    <div className="bg-slate-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-100">
                        <span className="text-[10px] text-[#0078d4] font-bold uppercase tracking-widest italic">Transaction Hub</span>
                    </div>
                </div>
            </div>
