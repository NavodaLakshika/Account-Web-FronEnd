...
const AdminAIChatbot = ({ isOpen, onClose }) => {
    ...
    const suggestions = [
        {
            title: "Quickly view active subscriptions and upcoming renewals across all companies.",
            action: "Show me subscription status for all companies"
        },
        {
            title: "Manage permissions and assign new roles to employees efficiently.",
            action: "How do I assign a new role to an employee?"
        },
        {
            title: "Audit system logs to track recent login activity and security events.",
