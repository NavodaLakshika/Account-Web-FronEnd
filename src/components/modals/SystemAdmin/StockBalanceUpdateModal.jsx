                            ...
                            <div className="col-span-12 lg:col-span-8 flex items-end gap-2">
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input type="text" value={stockDate} className="w-full h-10 border border-gray-300 rounded-[3px] px-3 text-[14px] bg-white outline-none focus:border-[#0285fd] focus:ring-1 focus:ring-[#0285fd] text-gray-700 " name="stockDate" onChange={(e) => setStockDate(e.target.value)} />
