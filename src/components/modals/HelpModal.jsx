...
const HelpModal = ({ isOpen, onClose }) => {
    return (
        <>
            ...
            <div
                className={`fixed top-1/2 right-4 -translate-y-1/2 w-[300px] h-[920px] max-h-[95vh] bg-white/95 backdrop-blur-[60px] z-[1000] rounded-[2px] border border-gray-200 transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] ${isOpen ? 'translate-x-0 opacity-100 shadow-[0_20px_50px_rgba(0,0,0,0.1)]' : 'translate-x-full opacity-0 pointer-events-none'
                    }`}
            ...
            >
                ...
                <div className="h-full flex flex-col p-5 overflow-hidden">
                    {/* Header Section */}
                    <div className="bg-transparent pb-3 flex items-center justify-between border-b border-gray-200 select-none relative shrink-0">
                    ...
                    <div className="flex-1 flex flex-col justify-between pb-4 overflow-hidden">
                        ...
                        <div className="space-y-3">
                            <h3 className="text-[9px] font-mono font-bold text-[#0091ca] tracking-[0.2em] uppercase border-b border-gray-200 pb-2 flex items-center gap-2">
                                System Overview
                            </h3>
                            <div className="bg-gray-50/50 p-4 rounded-[2px] border border-gray-200 space-y-4">
                        ...
                        <div className="space-y-3 pt-4 border-t border-gray-200">
                            ...
                            <div className="p-3 bg-gray-50 rounded-[2px] border border-gray-200 relative overflow-hidden group">
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-200 flex items-center justify-between opacity-50 shrink-0">
