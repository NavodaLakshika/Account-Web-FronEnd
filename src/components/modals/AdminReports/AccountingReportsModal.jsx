...
import { X, FileText, BarChart3, BookOpen, ClipboardList } from 'lucide-react';

const AccountingReportsModal = ({ isOpen, onClose }) => {
    if (!isOpen) return null;

    const menuItems = [
        { icon: FileText, label: 'Accounting Details' },
        { icon: BarChart3, label: 'Accounting Report' },
        { icon: BookOpen, label: 'Journal Entry Reports' },
        { icon: ClipboardList, label: 'Double Entry Details Report' },
    ];
            ...
            <div className="relative w-full max-w-sm bg-white border border-gray-100 rounded-xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-right-5 duration-300">
                ...
                <div className="bg-white px-6 py-4 flex items-center justify-between border-b border-gray-100 select-none relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[15px] font-[700] text-slate-900 uppercase tracking-[3px] font-mono truncate">Accounting Reports</span>
                    </div>
                    <button 
                        onClick={onClose} 
