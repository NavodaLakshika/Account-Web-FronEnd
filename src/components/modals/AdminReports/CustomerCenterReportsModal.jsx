...
import { X, Users, Clock, FileText, BarChart3, Receipt } from 'lucide-react';

const CustomerCenterReportsModal = ({ isOpen, onClose }) => {
    if (!isOpen) return null;

    const menuItems = [
        { icon: Clock, label: 'Debtor Aging Analyst' },
        { icon: FileText, label: 'Debtors Statement' },
        { icon: BarChart3, label: 'Debtors Balance Summary' },
        { icon: Receipt, label: 'Invoice Details' },
    ];
            ...
            <div className="relative w-full max-w-sm bg-white border border-gray-100 rounded-xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-right-5 duration-300">
                ...
                <div className="bg-white px-6 py-4 flex items-center justify-between border-b border-gray-100 select-none relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[15px] font-[700] text-slate-900 uppercase tracking-[3px] font-mono truncate">Customer Center Reports</span>
                    </div>
                    <button 
                        onClick={onClose} 
