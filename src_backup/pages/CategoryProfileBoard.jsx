...
const CategoryProfileBoard = ({ isOpen, onClose }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (data.message === 'inserted') { showSuccessToast('Category created'); handleClear(); }
    ...
    return (
        <>
            <TransactionFormWrapper boardName="CategoryProfileBoard" icon={null}
                isOpen={isOpen} onClose={onClose} title="Category"
                footer={
