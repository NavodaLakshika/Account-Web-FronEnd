        ...
        <div className="fixed inset-0 z-[3000] flex items-center justify-center bg-black/50 p-4 font-sans">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 overflow-hidden mb-6 flex flex-col">
                <div className="px-6 h-10 bg-gray-50 text-gray-600 text-sm font-bold rounded-xl hover:bg-gray-100 transition-all active:scale-95 flex items-center justify-center gap-2 border border-gray-100">
                    ...
                    <button onClick={onClose} className="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors rounded-xl">
                ...
                <form onSubmit={handleSubmit} className="">
                    <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="px-6 h-10 bg-gray-50 text-gray-600 text-sm font-bold rounded-xl hover:bg-gray-100 transition-all active:scale-95 flex items-center justify-center gap-2 border border-gray-100"
                                autoFocus
                            />
                        </div>
                    ...
                    <div className="mt-6 flex gap-3 justify-end">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="px-6 h-10 bg-[#0285fd] hover:bg-[#0073ff] text-white font-semibold rounded-xl shadow-sm text-[13px] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                            {saving ? (
