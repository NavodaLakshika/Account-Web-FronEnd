    ...
    return (
        ...
        >
            <div className="flex flex-col items-center text-center space-y-6 font-['Tahoma'] py-2">
                ...
                <button
                    onClick={onClose}
                    className="w-full h-11 bg-white text-[#ff3b30] border-2 border-[#ff3b30] hover:bg-red-50 text-[12px] font-black rounded-[3px] hover:bg-[#e03127] transition-all active:scale-95 uppercase tracking-[0.2em] shadow-[0_8px_20px_rgba(255,59,48,0.3)] hover:shadow-[0_12px_24px_rgba(255,59,48,0.4)] border-none"
                >
                    CLOSE DIALOG
                </button>
            </div>
